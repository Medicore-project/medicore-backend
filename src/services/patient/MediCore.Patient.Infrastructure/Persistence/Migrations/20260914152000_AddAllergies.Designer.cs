...
namespace MediCore.Patient.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260914152000_AddAllergies")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediCore.Patient.Application.Entities.Prescription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PrescriberClinicianId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("PrescriberClinicianEmail")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.Property<string>("PrescriberClinicianRole")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.HasIndex("PatientId", "PrescribedAtUtc")
            ...
            modelBuilder.Entity("MediCore.Patient.Application.Entities.Prescription", b =>
                {
                    ...
                    b.HasOne("MediCore.Patient.Application.Entities.MedicalRecord", null)
                        .WithMany()
                        .HasForeignKey("MedicalRecordId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
