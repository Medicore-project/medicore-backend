...
namespace MediCore.Appointment.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926041648_AddAppointmentHistory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediCore.Appointment.Application.Entities.Appointment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SlotDate", "DoctorId")
                        .HasDatabaseName("ix_appointments_date_doctor");

                    b.ToTable("appointments", "medicore_appointment");
                });

            modelBuilder.Entity("MediCore.Appointment.Application.Entities.AppointmentHistoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("appointment_history", "medicore_appointment");
                });
